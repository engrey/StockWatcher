...
public class StockWatcher implements EntryPoint {
	...
	private FlexTable stockList = new FlexTable();
	private Button addStockList = new Button("add");
	...
	/**  * Entry point method.  */  
	    ...
	    stockList.getRowFormatter().addStyleName(0, "watchListHeader");
	    stockList.addStyleName("watchList");
	    stockList.getCellFormatter().addStyleName(0, 1, "watchListNumericColumn");
	    stockList.getCellFormatter().addStyleName(0, 2, "watchListNumericColumn");
	    stockList.getCellFormatter().addStyleName(0, 3, "watchListRemoveColumn");
		
	    loadStocks();
	    
		// TODO Assemble Add Stock panel.
		addPanel.add(txtBox);
		addPanel.add(addStockList);
	    ...
	    addStockList.addClickHandler(new ClickHandler() {
	...
	protected void addStock() {
		  final String symbol = txtBox.getText().toUpperCase().trim();
		    txtBox.setFocus(true);
	...
	private void displayStocks(String[] symbols) {  for (String symbol : symbols) {  displayStock(symbol);  }  } 
	  ...
	  private void displayStock(final String symbol) {
		    ...
		    int row = stockList.getRowCount();
		    stocks.add(symbol);
		    stockList.setText(row, 0, symbol);
		    stockList.setWidget(row, 2, new Label());
		    stockList.getCellFormatter().addStyleName(row, 1, "watchListNumericColumn");
		    stockList.getCellFormatter().addStyleName(row, 2, "watchListNumericColumn");
		    stockList.getCellFormatter().addStyleName(row, 3, "watchListRemoveColumn");
		    ...
		    stockList.setWidget(row, 3, removeStockButton);
	  ...
	  private void removeStock(final String symbol) {
		  ...
		  private void undisplayStock(String symbol) {
		    ...
		    stockList.removeRow(removedIndex+1);
		  }
	/**
  ...
  private void updateTable(StockPrice price) {
    ...
    stockList.setText(row, 1, priceText);
    Label changeWidget = (Label)stockList.getWidget(row, 2);
